...
def answer_create(request,category_id,question_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect('{}#answer_{}'.format(resolve_url('pybo:detail',category_id=category_id,question_id= answer.question.id),answer.id))
    else:
...
def answer_modify(request,category_id, answer_id):
    ...
    if request.user != answer.author:
        ...
        return redirect('pybo:detail',category_id=category_id, question_id=answer.question.id)
...
def answer_vote(request,category_id,answer_id):
    ...
    # return redirect ('pybo:detail',question_id = answer.question.id)
    return redirect('{}#anawer_{}'.format(resolve_url('pybo:detail',category_id=category_id,question_id= answer.question.id),answer.id))
